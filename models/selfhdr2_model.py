...
#                           weight_decay=opt.weight_decay)
    ...
    def backward(self):
        ...
        #self.loss_Color = self.criterionCrossEntropy(self.data_out, self.data_color_label, label_mask).mean()
        self.loss_Color = self.criterionL2(self.data_out, self.data_color_label, label_mask).mean()
